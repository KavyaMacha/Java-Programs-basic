...
class Tree{
    ...
    static void print(TrieNode root, char[] str, int level) {
        ...
        // If node is leaf node, it indicates end of string, so a null character is added and string is printed
        if (isLeafNode(root)) {
...
1        char[] str = new char[50];

1        // printing content of Trie
        ...
        while (true) {
            ...
            // Ensure that the node to delete starts from the root of the Trie
            if (search(word)) {
